...
public:
  IncompleteRead( std::string const& what, std::string  partial, int ec )
    :
  ...
  [[nodiscard]] std::string get_partial() const
  {
    return partial_;
  }

  [[nodiscard]] int get_errorcode() const
  {
    return ec_;
  }
